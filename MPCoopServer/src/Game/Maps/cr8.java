...
//        super.addEnvironment(new TNT((byte)0, 350, 550));
        super.addEnvironment(new TNT((byte)1, 150, 800));
//        super.addEnvironment(new TNT((byte)2, 420, 1350));
        super.addEnvironment(new TNT((byte)3, 1400, 1250));
//        super.addEnvironment(new TNT((byte)4, 1400, 700));
        super.addEnvironment(new TNT((byte)5, 1100, 250));
//        super.addEnvironment(new TNT((byte)6, 500, 200));
        
        super.addEnvironment(new WoodenCrate1((byte)0, 350, 550));
//        super.addEnvironment(new WoodenCrate1((byte)1, 150, 800));
        super.addEnvironment(new WoodenCrate1((byte)2, 420, 1350));
//        super.addEnvironment(new WoodenCrate1((byte)3, 1400, 1250));
        super.addEnvironment(new WoodenCrate1((byte)4, 1400, 700));
//        super.addEnvironment(new WoodenCrate1((byte)5, 1100, 250));
        super.addEnvironment(new WoodenCrate1((byte)6, 500, 200));
        
        super.addEnvironment(new WoodenCrate1((byte)7, 800, 210));
        super.addEnvironment(new WoodenCrate1((byte)8, 800, 260));
        super.addEnvironment(new WoodenCrate1((byte)9, 800, 300));
        
        super.addEnvironment(new MobileDoubleSpikes((byte)10, 1150, 930));
        
        super.setLayer0(LoadTextures.cr81);
        super.setLayer2(LoadTextures.cr82);
    }
